...
const ICONS = {
	alert: (
		<HiBellAlert className="h-6 w-6 text-gray-900 group-hover:text-indigo-600 shrink-0" />
	),
	message: (
		<BiSolidMessageRounded className="h-6 w-6 text-gray-900 group-hover:text-indigo-600 shrink-0" />
	),
};
